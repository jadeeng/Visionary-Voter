...
def seed_data():
    ...
    event1= Event(zipcode= "90291", district= "33", state="CA", description="Attend a political rally featuring speakers Congress Representative Ted Lieu and Senator Kamala Harris")
